 ...
 */
define("theme_standarmoovePruebas/accessibilitysettings_modal", [
  "jquery",
  "core/notification",
  ...
  var registered = !1,
    ...
    AccessibilityModal = function (root) {
        ...
        Ajax.call([
          ...
          (document.getElementById("fonttype").value = result.fonttype),
            result.enableaccessibilitytoolbar &&
              (document.getElementById("enableaccessibilitytoolbar").checked =
                !0);
        });
    };
  return (
    (AccessibilityModal.TYPE = "theme_standarmoovePruebas-themesettings_modal"),
    ((AccessibilityModal.prototype = Object.create(
      Modal.prototype
    )).constructor = AccessibilityModal),
    (AccessibilityModal.prototype.registerEventListeners = function () {
      Modal.prototype.registerEventListeners.call(this),
        this.getModal().on(
          CustomEvents.events.activate,
          SELECTORS_SAVE_BUTTON,
          function () {
            Ajax.call([
              {
