...
define("theme_standarmoovepruebas/accessibilitybar", [
  ...
  return (
    (AccessibilityBar.prototype.registerEventListeners = function () {
      jQuery(SELECTORS_FONT_SIZE).click(
        function (element) {
          var btn = jQuery(element.currentTarget);
          (fontsizeCurrentAction = btn.data("action")), this.fontSize();
        }.bind(this)
      ),
        jQuery(SELECTORS_SITE_COLOR).click(
          function (element) {
            var btn = jQuery(element.currentTarget);
            (sitecolorCurrentAction = btn.data("action")), this.siteColor();
          }.bind(this)
        );
    }),
      ...
      Ajax.call([
        {
          ...
          args: { action: fontsizeCurrentAction },
        },
      ])[0].done(
        function () {
    ...
    (AccessibilityBar.prototype.reloadFontsizeClass = function () {
      if (
        "reset" === fontsizeCurrentAction ||
        ("increase" === fontsizeCurrentAction &&
          "fontsize-dec-1" === fontsizeClass) ||
        ("decrease" === fontsizeCurrentAction &&
          "fontsize-inc-1" === fontsizeClass)
      )
        return (
      ...
      Ajax.call([
        {
          ...
          args: { action: sitecolorCurrentAction },
        },
      ])[0].done(
        function () {
