...
$string['configtitle'] = "tema_pruebas_lucia Settings";
$string['choosereadme'] = '<div class="clearfix"><div class="theme_screenshot"><img class=img-polaroid src="tema_pruebas_lucia/pix/screenshot.jpg" /><br/><p></p><h3>Theme Credits</h3><p><h3>Moodle tema_pruebas_lucia theme</h3><p>This theme is based on the Boost Moodle theme.</p><p>Authors: LMSACE Dev Team<br>Contact: info@lmsace.com<br>Website: <a href="http://www.lmsace.com">www.lmsace.com</a><br></p>';

$string['configtitle'] = 'tema_pruebas_lucia';
...
$string['pluginname'] = 'tema_pruebas_lucia';
...
-Moodle development|https://moodle.org/development
Moodle.com|http://moodle.com/";
$string['privacy:metadata'] = 'The tema_pruebas_lucia theme does not store any personal data about any user.';
